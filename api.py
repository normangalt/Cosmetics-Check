...
class Ingredient:
    __slots__ = ('name', 'safety_assesment', 'description')
    def fill_up(self, entry):
        """
        Fills up the properties of the instance.

        Args:
            entry ([dict]): [dictionary with words to fill up the properties of the instance].
        """
        self.name = entry['name']
        self.safety_assesment = entry['property0']
        self.description = entry['property1']
